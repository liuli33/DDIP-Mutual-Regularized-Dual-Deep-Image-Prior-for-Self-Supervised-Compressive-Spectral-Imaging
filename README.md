...
```
DDIP/
├── CASSI_Restoration/              # Main implementation directory
│   ├── model/                      # Network architecture (SSFAN)
│   ├── Results/                    # Output directory for reconstructed images
│   ├── RGB/                        # RGB visualization directory
│   ├── func.py                     # Utility functions for data processing
│   ├── main_KAIST.py               # Main script for KAIST dataset
│   ├── main_real.py                # Main script for real data
│   ├── optimization_real.py        # Optimization for real data
│   ├── optimziation_HQS_acce.py   # Accelerated HQS optimization
│   └── test_metric.py              # Evaluation metrics (PSNR, SSIM, SAM)
│
├── Data/                           # Dataset and measurements
│   ├── KAIST_Dataset/              # KAIST hyperspectral dataset
│   └── TSA_real_data/              # Real captured data
│       ├── Measurements/           # Compressed measurements
│       │   ├── measurement/        # Raw measurement data
│       │   ├── scene1.mat ~ scene5.mat
│       │   └── readcave.py
│       ├── TSA_reconstruction/     # Reference reconstructions by DAUHST
│       │   ├── rgb/                # RGB visualizations
│       │   ├── Recon_scene1.mat ~ Recon_scene5.mat
│       │   └── readcave.py
│       ├── mask.mat                # Coded aperture mask
│       ├── mask_3d_shift.mat       # 3D shifted mask
│       └── mask_3d_shift_uint16.mat
│
└── README.md
```
