...
# from skimage.measure import comcompare_ssim, compare_psnr
from skimage.metrics import peak_signal_noise_ratio as compare_psnr
from skimage.metrics import structural_similarity as comcompare_ssim
...
def cal_psnr(im_true,im_test,eps=13-8):
    ...
    bwindex = []
    for i in range(c):
        bwindex.append(compare_psnr(im_true[i,:,:], im_test[i,:,:], data_range=1))
